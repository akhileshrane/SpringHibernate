...
<body>
	...
	<div class="w3-sidebar w3-light-grey w3-bar-block" style="width: 20%">
		...
		<a href="../add_new_book/Add_new_book.jsp"
			class="w3-bar-item w3-button">Add book</a> <a
			href="Search_by_ID_home.jsp" class="w3-bar-item w3-button">Add
			user</a> <a href="#" class="w3-bar-item w3-button">Issue book</a> <a
	...
	<div style="margin-left: 20%">
		...
		<div class="w3-container">
			<h2>Search result</h2>
			<center>
				<h1 style="color: green;">Book issued</h1>
				<br>
				<table>
